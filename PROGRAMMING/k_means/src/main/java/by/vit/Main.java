...
public class Main {
    ...
    private static final String pathToDirectoryWithNewFiles = "E:\\Work\\vitaluga\\PROGRAMMING\\Test_Task\\clusters\\";
    private static final String pathToDirectoryWithFilesToParse = "\"E:\\\\Work\\\\vitaluga\\\\PROGRAMMING\\\\Test_Task\\\\access_logs\"";


    public static void main(String[] args) {

        File badRecords = createFileWithBadRecords();
        Map<String, File> ipFileMap = createFileForOneIP();
        File localHostFile = createFileLocalHostIP();
        ...
        for (File f : filesToParse) {
            parse(f, listsOfRecords, badRecords, ipFileMap, localHostFile);
        }
